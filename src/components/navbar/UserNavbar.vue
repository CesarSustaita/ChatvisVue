...
<template>
  <div class="navUser">
    <div class="seccion1">
      ...
      <div class="upLoad">
        <RouterLink to="/lector" type="button" class="btn btn-dark"
          ><i class="fa-solid fa-upload" style="color: #ffffff"></i> Subir Archivo
        </RouterLink>
      </div>
    </div>
    <div class="seccion2">
      ...
      <div class="line" style="color: #a3a3a3">|</div>
      <div class="profile-icon">
        <div class="btn-group" role="group">
          <button
            type="button"
            class="btn icon-button dropdown-toggle"
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <h5>Importante</h5>
          <p>
            El analizador ChatVis no guardará ninguna conversación analizada, para la seguridad de
            todos.
          </p>
        </div>
      </div>
